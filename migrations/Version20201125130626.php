 ...
 */
final class Version20201125130626 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE about (id INT AUTO_INCREMENT NOT NULL, rotate VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, birth DATETIME NOT NULL, address VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, projects INT NOT NULL, name VARCHAR(255) NOT NULL, phone INT NOT NULL, file_name_photo VARCHAR(255) NOT NULL, file_name_cv VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE projects (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, page_path VARCHAR(255) NOT NULL, photo_path VARCHAR(255) NOT NULL, is_public TINYINT(1) NOT NULL, modificated_at DATETIME NOT NULL, uploaded_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
